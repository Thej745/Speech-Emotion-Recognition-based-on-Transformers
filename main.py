...
import numpy as np
import pandas as pd
from model import ModelForClf

from sklearn.metrics import f1_score, classification_report
from sklearn.metrics import confusion_matrix
from sklearn.metrics import accuracy_score

from utils import report, plot_training
...
def trainModel(data_path, check_point, lr, epocks, weight_decay, sch_gamma, sch_step,
    ...
    #data_distribution(df, label_encoder.classes_)
    ...
    best_model = ModelForClf(check_point,num_classes)
    ...
    print('-' * 30, '\nModel on validation set -> Loss =', test_loss, f'Accuracy = {test_acc * 100:.2f} %')
